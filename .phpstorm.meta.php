...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/cecepsaepul/Sites/web-pc-ipnu-ippnu-pangandaran-/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/cecepsaepul/Sites/web-pc-ipnu-ippnu-pangandaran-/public/storage','logging.default',
...
'inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','permission.models.permission',
...
'web','api',);
        registerArgumentsSet('routes', 'company.home','company.history','berita.index','berita.store',
'berita.update','berita.destroy','berita.show',
'users.destroy','users.management','article.management','profile.edit','profile.update',
'profile.destroy','login','authlogin','register',
...
'admin.admin','admin.articlemanagement','admin.usermanagemen','auth.confirm-password','auth.forgot-password',
'auth.login','auth.register','auth.reset-password','auth.verify-email','company.history',
'company.home','company.news','components.application-logo','components.auth-session-status','components.danger-button',
'components.dropdown','components.dropdown-link','components.footer','components.header','components.input-error',
'components.input-label','components.modal','components.nav-link','components.primary-button','components.responsive-nav-link',
'components.secondary-button','components.text-input','dashboard','layouts.app','layouts.guest',
'layouts.layouts','layouts.navigation','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default',
...
'pagination::tailwind','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'user.dashboarduser','user.user','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default',
...
'vendor.pagination.tailwind','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.copy-button',
